...
4. Если пользователь просит пояснить какой-либо термин, который попросил его заполнить \
   LLM на предыдущем шаге, то это continue=false.
5. Если в сессии указан тип документа A, а пользователь просит создать документ B — это \
